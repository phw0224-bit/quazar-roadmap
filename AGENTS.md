...
item_github_issues, item_github_pull_requests, github_repository_settings -- GitHub 이슈/PR 연결 및 레포 티켓 설정
```
...
- `item_github_pull_requests`: 아이템과 GitHub PR 연결 정보, 생성된 PR은 상세 속성 박스에 표시
...
**GitHub PR 생성:**
- ItemDetailPanel에서 연결 이슈 + 브랜치 확인 후 PR 액션 버튼 클릭
